...
import { Coffee, LayoutDashboard, LogOut, Settings, ShoppingBag, Store, Users } from 'lucide-react'
  ...
  return (
    <aside className='fixed right-0 top-0 z-40 h-screen w-64 flex flex-col border-l border-border bg-white'>
        <div className="flex h-16 items-center justify-center border-b border-border bg-primary">
            <h1 className="text-xl font-sansBlack font-black text-primary-foreground">پنل مدیریت نیک</h1>
        </div>
        ...
        <div className="border-t border-border p-4">
            <button
                className='flex w-full items-center gap-3 rounded-lg px-4 py-4 text-right text-danger transition-all hover:bg-danger/10 font-black font-sansBold text-2xl cursor-pointer'
            >
