        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            <div className="rounded-xl bg-white p-4 shadow-md cursor-pointer transition-all hover:shadow-lg">
                <div className="flex items-center justify-between">
                    ...
                    <Badge variant='secondary' className='bg-primary/10'>0</Badge>
                </div>
            </div>
            <div className="rounded-xl bg-white p-4 shadow-md cursor-pointer transition-all hover:shadow-lg">
                <div className="flex items-center justify-between">
                    ...
                    <Badge variant='secondary' className='bg-green-100 text-green-600'>0</Badge>
                </div>
            </div>
            <div className="rounded-xl bg-white p-4 shadow-md cursor-pointer transition-all hover:shadow-lg">
                <div className="flex items-center justify-between">
                    ...
                    <Badge variant='secondary' className='bg-blue-100 text-blue-600'>0</Badge>
                </div>
            </div>
            <div className="rounded-xl bg-white p-4 shadow-md cursor-pointer transition-all hover:shadow-lg">
                <div className="flex items-center justify-between">
                    ...
                    <Badge variant='secondary' className='bg-yellow-100 text-yellow-600'>0</Badge>
                </div>
            </div>
            <div className="rounded-xl bg-white p-4 shadow-md cursor-pointer transition-all hover:shadow-lg">
                <div className="flex items-center justify-between">
